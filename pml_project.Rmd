...
We selected **Random Forest** as our classification method of choice for predicting the activity quality in the validation set given its good results and well-deserved popularity in challenging competitions.
